    ...
    public override fun doGet(request: HttpServletRequest, response: HttpServletResponse) {
        ...
        when (cmd.toLowerCase()) {
            "config" ->
                ...
                out.println(config())
            "sum" -> out.println(parkhausServiceSession.get().sum(NAME()))
            "cars" -> {
            ...
            "average" ->  out.println(parkhausServiceSession.get().average(NAME()))


            "total users" -> out.println(parkhausServiceSession.get().totalUsers(NAME()))
